...
public class GrandfatherWillisModel<T extends GrandfatherWillisEntity> extends EntityModel<T> {
    ...
    @Override
    public void setupAnim(@Nonnull T entity, float limbSwing, float limbSwingAmount, float ageInTicks,
    ...
    @Override
    public void renderToBuffer(@Nonnull PoseStack matrixStack, @Nonnull VertexConsumer buffer, int packedLight,
